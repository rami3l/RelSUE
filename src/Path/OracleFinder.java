...
public class OracleFinder {
    static int K = 20;
    static double threshold = 0.5; // 两个数据集保持一致
       ...
       // System.out.println("Begin finding...");
        while(OpenList.size() > 0 && paths.size() < K){
           ...
           // System.out.println("open list size: " + OpenList.size());
            ...
            //System.out.println("paths size: " + paths.size() + "  examples size: " + examples.size());
            OpenList.remove(max);
           ...
           long end = System.currentTimeMillis();
          // System.out.println("time for extending: " + (end - start));
           /* if(System.currentTimeMillis() - start_time_stamp > 60000){
                break;
            }*/
